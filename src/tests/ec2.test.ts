...
Deno.test('EC2', () => {
  ...
  assertEquals(EC2.CapacityReservationFleet, 'AWS::EC2::CapacityReservationFleet')
  assertEquals(EC2.CarrierGateway, 'AWS::EC2::CarrierGateway')
  assertEquals(EC2.ClientVpnAuthorizationRule, 'AWS::EC2::ClientVpnAuthorizationRule')
  assertEquals(EC2.ClientVpnEndpoint, 'AWS::EC2::ClientVpnEndpoint')
  assertEquals(EC2.ClientVpnRoute, 'AWS::EC2::ClientVpnRoute')
  assertEquals(EC2.ClientVpnTargetNetworkAssociation, 'AWS::EC2::ClientVpnTargetNetworkAssociation')
  ...
  assertEquals(EC2.EgressOnlyInternetGateway, 'AWS::EC2::EgressOnlyInternetGateway')
  assertEquals(EC2.EIP, 'AWS::EC2::EIP')
  assertEquals(EC2.EIPAssociation, 'AWS::EC2::EIPAssociation')
  assertEquals(EC2.EnclaveCertificateIamRoleAssociation, 'AWS::EC2::EnclaveCertificateIamRoleAssociation')
  assertEquals(EC2.FlowLog, 'AWS::EC2::FlowLog')
  assertEquals(EC2.GatewayRouteTableAssociation, 'AWS::EC2::GatewayRouteTableAssociation')
  ...
  assertEquals(EC2.LocalGatewayRouteTableVPCAssociation, 'AWS::EC2::LocalGatewayRouteTableVPCAssociation')
  ...
  assertEquals(EC2.NetworkInsightsAccessScope, 'AWS::EC2::NetworkInsightsAccessScope')
  assertEquals(EC2.NetworkInsightsAccessScopeAnalysis, 'AWS::EC2::NetworkInsightsAccessScopeAnalysis')
  assertEquals(EC2.NetworkInsightsAnalysis, 'AWS::EC2::NetworkInsightsAnalysis')
  ...
  assertEquals(EC2.NetworkInterfaceAttachment, 'AWS::EC2::NetworkInterfaceAttachment')
  assertEquals(EC2.NetworkInterfacePermission, 'AWS::EC2::NetworkInterfacePermission')
  ...
  assertEquals(EC2.SubnetNetworkAclAssociation, 'AWS::EC2::SubnetNetworkAclAssociation')
  assertEquals(EC2.SubnetRouteTableAssociation, 'AWS::EC2::SubnetRouteTableAssociation')
  assertEquals(EC2.TrafficMirrorFilter, 'AWS::EC2::TrafficMirrorFilter')
  assertEquals(EC2.TrafficMirrorFilterRule, 'AWS::EC2::TrafficMirrorFilterRule')
  ...
  assertEquals(EC2.TransitGatewayAttachment, 'AWS::EC2::TransitGatewayAttachment')
  assertEquals(EC2.TransitGatewayConnect, 'AWS::EC2::TransitGatewayConnect')
  assertEquals(EC2.TransitGatewayMulticastDomain, 'AWS::EC2::TransitGatewayMulticastDomain')
  assertEquals(EC2.TransitGatewayMulticastDomainAssociation, 'AWS::EC2::TransitGatewayMulticastDomainAssociation')
  assertEquals(EC2.TransitGatewayMulticastGroupMember, 'AWS::EC2::TransitGatewayMulticastGroupMember')
  assertEquals(EC2.TransitGatewayMulticastGroupSource, 'AWS::EC2::TransitGatewayMulticastGroupSource')
  assertEquals(EC2.TransitGatewayPeeringAttachment, 'AWS::EC2::TransitGatewayPeeringAttachment')
  assertEquals(EC2.TransitGatewayRoute, 'AWS::EC2::TransitGatewayRoute')
  assertEquals(EC2.TransitGatewayRouteTable, 'AWS::EC2::TransitGatewayRouteTable')
  assertEquals(EC2.TransitGatewayRouteTableAssociation, 'AWS::EC2::TransitGatewayRouteTableAssociation')
  assertEquals(EC2.TransitGatewayRouteTablePropagation, 'AWS::EC2::TransitGatewayRouteTablePropagation')
  assertEquals(EC2.TransitGatewayVpcAttachment, 'AWS::EC2::TransitGatewayVpcAttachment')
  ...
  assertEquals(EC2.VPCDHCPOptionsAssociation, 'AWS::EC2::VPCDHCPOptionsAssociation')
  assertEquals(EC2.VPCEndpoint, 'AWS::EC2::VPCEndpoint')
  assertEquals(EC2.VPCEndpointConnectionNotification, 'AWS::EC2::VPCEndpointConnectionNotification')
  assertEquals(EC2.VPCEndpointService, 'AWS::EC2::VPCEndpointService')
  assertEquals(EC2.VPCEndpointServicePermissions, 'AWS::EC2::VPCEndpointServicePermissions')
  ...
  assertEquals(EC2.VPNGatewayRoutePropagation, 'AWS::EC2::VPNGatewayRoutePropagation')
})