...
Deno.test('APIGateway', () => {
  ...
  assertEquals(APIGateway.ClientCertificate, 'AWS::APIGateway::ClientCertificate')
  assertEquals(APIGateway.Deployment, 'AWS::APIGateway::Deployment')
  assertEquals(APIGateway.DocumentationPart, 'AWS::APIGateway::DocumentationPart')
  assertEquals(APIGateway.DocumentationVersion, 'AWS::APIGateway::DocumentationVersion')
  ...
  assertEquals(APIGateway.RequestValidator, 'AWS::APIGateway::RequestValidator')
